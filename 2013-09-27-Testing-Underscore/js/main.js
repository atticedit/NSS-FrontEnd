...
{
  return _.filter(strings, function(string) {return string.length > 3;});
}

function filter_medium_strings(strings)
{
  return _.filter(strings, function(string) {return string.length > 2 && string.length < 5;});
}
