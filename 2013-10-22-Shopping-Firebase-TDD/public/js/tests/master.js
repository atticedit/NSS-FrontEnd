...
test('Add Items to Order', function(){
  expect(14);
  ...
  equal($('#cart tbody tr').length, 0, 'should be no rows in cart tbody after purchase');
  equal($('#cart-grand').text(), '', 'should be no cart grand total after purchase');
