// 10/9/13 1:15 PM version
// as it existed just after lunch
// Chyld's version with notations by me, and changed to use my Firebase url
...
function receiveDb(snapshot){
  ...
  // checks if a child of db named items exists and creates an emoty array if it doesn't
  if(inventory.items){
