// 10/9/13 4:00 PM version
// Chyld's version changed to use my Firebase url, and with name of the
// childAdded function changed to chyldAdded
// Reflects all changes made during class on Wednesday 10/9/13
...
function initialize(){
  ...
  Δitems.on('child_added', chyldAdded);
}

function chyldAdded(snapshot){
