// written together in class on 2013-10-21
// this version incorporates code Chyld added after class and pushed to GitHub
// plus comments
...
function clickAddStudent(){
  ...
  // ask the value of the choice selected from the dropdown
